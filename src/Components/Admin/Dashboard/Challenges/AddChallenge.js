...
function AddChallenge() {
  ...
  const onSubmit = (challenge) => {
    axios
      .post("https://anasmhd.tk/admin/add-challenge", challenge)
      .then((response) => {
  ...
  const toInputUppercase = e => {
    let result = e.target.value.slice(0,1).toUpperCase() + e.target.value.slice(1, e.target.value.length)
